...
<div class="flex min-h-full w-full flex-col space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">
                {{ $student->roll_number ? 'Roll number ' . $student->roll_number : 'Roll number not assigned' }}
            </p>
        </div>
    ...
    <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div class="mb-5">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Student-related information will appear here as modules are added.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="rounded-xl border border-gray-100 bg-gray-50 p-5">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Attendance history will be available here.
                </p>
            </div>
            ...
            <div class="rounded-xl border border-gray-100 bg-gray-50 p-5">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Fee information will be available here.
                </p>
            </div>
            ...
            <div class="rounded-xl border border-gray-100 bg-gray-50 p-5">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Academic information can be added later.
                </p>
            </div>
