                ...
                @foreach ($sections as $section)
                    ...
                    <tr class="transition hover:bg-gray-50">
                        ...
                        @foreach ($columns as $column)
                            ...
                            @php
                                $value = data_get($section, $column['key']);
                            @endphp
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        document
            .querySelectorAll('.section-actions[open]')
    ...
    /*
     * Reload only the section datatable.
     */
    function loadSectionTable(form) {

        const table =
            document.querySelector('#section-datatable');
        ...
        .then((html) => {
            ...
            const replacement =
                new DOMParser()
                    ...
                    .querySelector('#section-datatable');
                ...
                if (shouldRestoreSearchFocus) {
                    ...
                    const nextSearchInput =
                        document.querySelector(
                            '[data-section-filter-form] input[name="search"]'
                        );
    ...
    document.addEventListener('input', function (event) {
        ...
        searchTimer = setTimeout(
            () => loadSectionTable(event.target.form),
            350
        );
